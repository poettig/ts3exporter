...
func TestVirtualServerStructTags(t *testing.T) {
	...
	expected := VirtualServer{
		...
		ControlPacketLoss:              0.01,
		SpeechPacketLoss:               0.3035,
		KeepAlivePacketLoss:            0.0023,
		PacketLoss:                     0,
		Ping:                           23,
	}
